...
export class MetadataStack extends cdk.Stack implements MetadataStackOutputs {
    constructor(scope: Construct, id: string, props: MetadataStackConfigType) {
        ...
        if (!metadataTable) {
            throw new Error('metadataTable is required in MetadataStackConfig');
        }
    ...
    private updateMetadataTable(
        ...
        const lambdaBuilder = new LambdaBuilder(this, `deployMetadataTable-${props.environment}`, {
            ...
            .addPolicy(
                new iam.PolicyStatement({
                    ...
                    resources: [metadataTableARN, `${metadataTableARN}/index/by-category`],
                }),
            );
        ...
        new AwsCustomResource(this, `InvokeMetadataTableLambda-${props.environment}`, {
            onUpdate: {
                service: 'Lambda',
                action: 'invoke',
                parameters: {
                ...
                physicalResourceId: PhysicalResourceId.of(
                    `${metadataTableName}-table-init-${runTimestamp}`,
                ), // Timestamp to force invoke
            },
