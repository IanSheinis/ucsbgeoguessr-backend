...
export class DynamoDBStack extends cdk.Stack implements DynamoDBStackOutputs {
  ...
  constructor(scope: Construct, id: string, props: DynamoDBStackConfigType) {
    ...
    new cdk.CfnOutput(this, "MetadataTableName", {
      ...
      exportName: `${props.environment}-MetadataTableName`,
      description: `Image metadata table name for ${props.environment} environment`,
    });
    new cdk.CfnOutput(this, "MetadataTableARN", {
      value: metadataTable.tableArn,
      exportName: `${props.environment}-MetadataTableArn`,
